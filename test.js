async function postData(url='', data= {}) {
	const response = await fetch(url, {
		...
		cache: 'no-cache',
		header: {
			"X-NCP-APIGW-API-KEY-ID": "1dpgj5ppss",
			"X-NCP-APIGW-API-KEY": "p8RFrh4Z5zCDOpMymuFg0y0VleckWyIv4pVO0LNL",
...
console.log(postData("https://naveropenapi.apigw.ntruss.com/sentiment-analysis/v1/analyze",{"content": `
# 2. 마크다운 사용법(문법)
## 2.1. 헤더Headers
* 큰제목: 문서 제목
